...
import { bussnes } from "../Api";
import "../App.css";

const BusinessWork = () => {
  const text = "BusinessWork";
  ...
  return (
    <>
      <Box
        ...
        h="600px"
        bg="rgba(255,0,0,0.1)"
        bgImage="url(https://images.unsplash.com/photo-1525182164759-c4a7ac2616f3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)"
        bgSize="cover"
        // bgSize="cover"
        // pos="absolute",
        top="0"
      ...
      >
        <Box textAlign="left" paddingTop="200px" paddingLeft="200px">
          ...
          <Text color="white" fontSize="20px">
            ...
            — <br /> from images of remote working and start-ups to shots of
            engineers and <br /> artists at work.
          </Text>
