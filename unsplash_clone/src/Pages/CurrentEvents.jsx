...
import { currentEvent } from "../Api";
import "../App.css";

const CurrentEvents = () => {
  const text = "CurrentEvents";
  ...
  return (
    <>
      <Box
        ...
        h="600px"
        bg="rgba(255,0,0,0.1)"
        bgImage="url(https://images.unsplash.com/photo-1657616696868-6e2a3d05b5b4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)"
        bgSize="cover"
        // bgSize="cover"
        // pos="absolute",
        top="0"
      ...
      >
        <Box textAlign="left" paddingTop="200px" paddingLeft="200px">
          ...
          <Text color="white" fontSize="20px">
            Covering the latest important events, news-worthy moments and <br />{" "}
            movements from around the world — from political protests to
            cultural <br /> celebrations. When submitting, please provide a
            photo description so we <br />
