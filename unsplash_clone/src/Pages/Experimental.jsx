  ...
  return (
    <>
      <Box
        ...
        h="600px"
        bg="rgba(255,0,0,0.1)"
        bgImage="url(https://images.unsplash.com/photo-1643827982014-87c3f7a14b1e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80)"
        bgSize="cover"
        // bgSize="cover"
        // pos="absolute",
        top="0"
      ...
      >
        <Box textAlign="left" paddingTop="200px" paddingLeft="200px">
          ...
          <Text color="white" fontSize="20px">
            ...
            new <br /> formats — photography has the power to challenge our
            perspectives and <br />
